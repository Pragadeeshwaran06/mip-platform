...
function LandingPage({ setCurrentPage }) {
  return (
    <main className="flex-grow flex flex-col items-center text-center relative overflow-hidden w-full">
      ...
      <div className="container-responsive section-padding relative z-10">
        ...
        <h1 className="font-extrabold tracking-tight text-slate-900 mb-8 leading-tight">
        ...
        <p className="subtext text-slate-600 max-w-2xl mx-auto mb-12 leading-relaxed">
      ...
      <div className="grid-cards container-responsive section-padding text-left">
